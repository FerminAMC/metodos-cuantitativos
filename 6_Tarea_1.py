...
life_time = 600 # This needs to be changed to the random number
...
Components_a.append(Component(life_time))
Components_a.append(Component(life_time))
Components_a.append(Component(life_time))
Components_a.append(Component(life_time))

Components_b.append(Component(life_time))
Components_b.append(Component(life_time))
Components_b.append(Component(life_time))
Components_b.append(Component(life_time))
...
while (total_hours_a > 0):
    ...
    for j in range(len(Components_a)):
        ...
        if(Components_a[j].life_time == 0):
            ...
            total_hours_a -= 1
            Components_a[j].life_time = life_time
...
while (total_hours_b > 0):
    ...
    while (j < len(Components_b)):
        ...
        if (Components_b[j].life_time == 0):
            ...
            total_hours_b -= 2
            Components_b[0].life_time = life_time
            Components_b[1].life_time = life_time
            Components_b[2].life_time = life_time
            Components_b[3].life_time = life_time
            j = 3
        j += 1

print ("Cost b: ", cost_b)

#NOTE: It is cheaper to reduce the downtime of the equipment than to maximize the time a component remains in operation
